...
@section('page-title', 'Project Validation')
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    <h5 class="card-title fw-bold mb-1">Project Validation</h5>
                    <p class="text-muted mb-0 fs-2">Review and verify projects assigned to you.</p>
                </div>
                <div class="d-flex align-items-center gap-3">
                    <div class="text-end d-none d-md-block">
                        <label class="form-label mb-0 fs-2 text-muted text-uppercase fw-semibold">Filter Status</label>
                        <select id="statusFilter" class="form-select form-select-sm border-0 bg-light-subtle fw-semibold" style="min-width: 200px;">
                            <option value="pending" selected>Pending Validation</option>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle border-light" id="dosenApprovalTable">
                    <thead class="bg-light-subtle">
                        <tr>
                            <th class="ps-3 py-3 border-0">No</th>
                            <th class="py-3 border-0">Project Info</th>
                            <th class="py-3 border-0">Category & Program</th>
                            <th class="py-3 border-0 text-center">Year/Sem</th>
            ...
            <div class="modal-content">
                <form id="processForm">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Process Project Approval</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="approvalStatus" class="form-select" required>
                                <option value="verified_by_dosen">Verify / Approve</option>
                                <option value="rejected_by_dosen">Reject</option>
                            </select>
                        </div>
    ...
    <script>
        $(document).ready(function() {
                ...
                columns: [
                    ...
                    { 
                        ...
                        render: function(data, type, row) {
                            return `<div class="badge bg-light text-dark fw-medium border">${data}</div><br><span class="fs-1 text-muted">Smt: ${row.semester}</span>`;
                        }
                    },
            ...
            $('#processForm').on('submit', function(e) {
                e.preventDefault();
                let url = "{{ route('dosen.verify', ':id') }}".replace(':id', currentId);
